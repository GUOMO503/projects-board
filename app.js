const STAGES = [
  ...
  {
    id: 5, title: '外立面施工 Exterior Cladding', icon: '🏡',
  ...
  {
    id: 6, title: '机电安装 Rough-in MEP', icon: '🔌',
  ...
  {
    id: 7, title: '保温施工 Insulation', icon: '🧊',
  ...
  {
    id: 9, title: '室内装修 Interior Finishing', icon: '🛋️',
